// -----------------------------------------------------------------------------
// ExperienceManager.UI.CustomPopupManager
// -----------------------------------------------------------------------------
//
...
import ExperienceManager.Registry.*
...
public class CustomPopupManager extends ICustomPopupManager {
	...
	public static func GetInstance(game: GameInstance) -> ref<CustomPopupManager> {
		...
		let instance: ref<CustomPopupManager> = registry.Get(n"ExperienceManager.UI.CustomPopupManager") as CustomPopupManager;
