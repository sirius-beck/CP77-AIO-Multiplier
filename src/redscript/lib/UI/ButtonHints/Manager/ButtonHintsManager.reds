// -----------------------------------------------------------------------------
// ExperienceManager.UI.ButtonHintsManager
// -----------------------------------------------------------------------------
//
...
public class ButtonHintsManager extends IButtonHintsManager {
	...
	public static func GetInstance(game: GameInstance) -> ref<ButtonHintsManager> {
		...
		let instance: ref<ButtonHintsManager> = registry.Get(n"ExperienceManager.UI.ButtonHintsManager") as ButtonHintsManager;
