// -----------------------------------------------------------------------------
// ExperienceManager.Localization.LocalizationSystem
// -----------------------------------------------------------------------------
//
...
public class LocalizationSystem extends ScriptableSystem {
	...
	public static func GetInstance(game: GameInstance) -> ref<LocalizationSystem> {
		return GameInstance.GetScriptableSystemsContainer(game).Get(n"ExperienceManager.Localization.LocalizationSystem") as LocalizationSystem;
	}
}
