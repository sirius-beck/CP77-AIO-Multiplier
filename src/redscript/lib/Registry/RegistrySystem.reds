// -----------------------------------------------------------------------------
// ExperienceManager.Registry.RegistrySystem
// -----------------------------------------------------------------------------
//
...
module ExperienceManager.Registry
...
public class RegistrySystem extends ScriptableSystem {
	...
	public static func GetInstance(game: GameInstance) -> ref<RegistrySystem> {
		return GameInstance.GetScriptableSystemsContainer(game).Get(n"ExperienceManager.Registry.RegistrySystem") as RegistrySystem;
	}
}
